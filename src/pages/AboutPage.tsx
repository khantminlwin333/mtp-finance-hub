...
const AboutPage = () => {
  const features = [
    {
      ...
      description:
        "Automate invoice creation with intelligent templates that learn from your patterns, reducing errors by 95%.",
      color: "text-blue-500",
    ...
    },
    {
      ...
      description:
        "Get AI-driven forecasts and insights to optimize your financial decisions before they happen.",
    ...
    },
    {
      ...
      description:
        "Personalized budget plans that adapt to your lifestyle and financial goals in real-time.",
  ...
  const freePlanFeatures = [
    ...
    {
      text: "Limited to 2 images per scan",
      icon: Camera,
        ...
        <div className="container mx-auto relative z-10">
          <div className="max-w-5xl">
            ...
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-8 sm:mb-10 max-w-2xl">
              Join thousands who've transformed their financial management with
              Finance MTP. Available for free with premium features accessible
              directly in the app.
            </p>
            ...
            <div className="space-y-6 sm:space-y-8">
              <div>
                ...
                <p className="text-base sm:text-lg text-muted-foreground mb-4 sm:mb-6">
                  We believe everyone deserves financial clarity without
                  complexity. Our mission is to democratize financial management
                  through intuitive tools and AI-powered insights.
                </p>
          ...
          <div className="mt-20 max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground">
                All premium features are managed directly within the app
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="border rounded-2xl p-8">
                <div className="mb-6">
                  ...
                  <p className="text-muted-foreground">
                    Perfect for getting started with basic financial management
                  </p>
                </div>
          ...
          <div className="mt-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                ...
                >
                  <div
                    className={`p-4 rounded-xl w-fit mb-6 ${feature.bgColor}`}
                  >
