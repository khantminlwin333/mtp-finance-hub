  ...
  const steps = [
    {
      ...
      description: "Sign up for a free account in minutes. All you need is an email address to get started.",
    ...
    },
    {
      ...
      description: "Easily log your income, expenses, and savings. No need to connect to your bank account.",
    ...
    },
    {
      ...
      description: "Use our tools to create budgets, track bills, and manage your savings goals.",
    ...
    },
    {
      ...
      description: "Get alerts for upcoming bills and when you're approaching your budget limits.",
        ...
        <div className="container mx-auto relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
              A simple, privacy-focused approach to financial management. Get started in minutes without connecting your bank.
            </p>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="relative">
            ...
            <div className="block lg:hidden absolute left-8 top-0 bottom-0 w-1 bg-gradient-to-b from-primary via-accent to-primary"></div>
            ...
            {steps.map((step, index) => (
              ...
              >
                {/* Timeline Node */}
                <div className="absolute left-0 lg:left-1/2 transform lg:-translate-x-1/2 -translate-x-1/2 w-16 h-16 rounded-full bg-background border-4 border-white shadow-lg flex items-center justify-center z-10">
                ...
                <div className={`ml-24 lg:ml-0 lg:w-[calc(50%-4rem)] ${
                  ...
                  <div className={`group p-8 rounded-2xl border backdrop-blur-sm transition-all duration-300 hover:shadow-xl hover:-translate-y-1 ${step.bgColor}`}>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-r from-primary/5 via-background to-accent/5 border rounded-3xl p-12 backdrop-blur-sm">
                <div className="w-24 h-24 mx-auto mb-8 rounded-full bg-gradient-to-r from-primary to-accent flex items-center justify-center">
                  <Smartphone className="w-12 h-12 text-white" />
                </div>
                <h2 className="text-4xl md:text-5xl font-bold mb-6">
                  Ready to Take Control of Your 
                  <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent"> Finances?</span>
                </h2>
                <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
                  Join thousands of users who have simplified their financial management with MTP Finance Hub
                </p>
                
                <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
                  <Button size="lg" className="gap-2 flex-1" asChild>
                    <a href="https://apps.apple.com/app/mtp-finance-hub/idYOUR_APP_ID" target="_blank" rel="noopener noreferrer">
